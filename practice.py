...
def halvesies(numbers):
    ...
    """ Takes entire numbers list and divides each element of the list
        by the variable divide_by, which is a float so that the half
        doesn't get rounded off
        """
    numbers[:] = [i / divide_by for i in numbers]
    return numbers
